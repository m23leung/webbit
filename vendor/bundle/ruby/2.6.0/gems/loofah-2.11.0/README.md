...
HTML, another rule of thumb is that _documents_ have `html` and `body`
tags, and _fragments_ usually do not.
...
However, Loofah **never enables this Nokogiri configuration**; Loofah
